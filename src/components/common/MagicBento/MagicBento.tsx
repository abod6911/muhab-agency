...
const DEFAULT_GLOW_COLOR = '166, 255, 46';
...
const defaultCardData: BentoCardProps[] = [
  {
    ...
    description: 'Ultra-low latency global infrastructure delivering sub-40ms response times.',
    label: 'Architecture'
  },
  {
    color: '#04170f',
    title: 'Saudi Gateways',
    description: 'Seamless Mada, Apple Pay, Tabby, and Tamara instant checkout integrations.',
    label: 'Fintech'
  },
  {
    color: '#04170f',
    title: '120 FPS Fluid Motion',
    description: 'Hybrid GPU acceleration with Three.js and GSAP for cinematic web experiences.',
    label: 'Visual Engine'
  },
  {
    color: '#04170f',
    title: 'Smart NFC Hardware',
    description: 'Encrypted physical cards and touchpoints instantly triggering digital journeys.',
    label: 'IoT Integration'
  },
  {
    color: '#04170f',
    title: 'Autonomous AI',
    description: 'Custom intelligent agents handling complex workflows and client inquiries 24/7.',
    label: 'Automation'
  },
  {
    color: '#04170f',
    title: 'Zero-Trust Security',
    description: 'Bank-grade encryption conforming to strict National Cybersecurity Authority standards.',
    label: 'Protection'
  }
];
      ...
      <BentoCardGrid gridRef={gridRef} className={className}>
        {cards.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: {
              backgroundColor: card.color || '#04170f',
          ...
          const cardContent = (
            <>
              <div className="magic-bento-card__header">
                ...
                {card.icon && <div className="text-[#a6ff2e]">{card.icon}</div>}
              </div>
              <div className="magic-bento-card__content">
                <h3 className="magic-bento-card__title">{card.title}</h3>
                <p className="magic-bento-card__description">{card.description}</p>
                {card.stats && (
                  <div className="mt-3 pt-2 border-t border-emerald-500/20 text-xs font-mono font-medium text-emerald-400">
                    {card.stats}
                  </div>
                )}
              </div>
